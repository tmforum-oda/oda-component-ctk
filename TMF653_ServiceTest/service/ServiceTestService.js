...
const {
  setBaseProperties, traverse,
  addHref, processCommonAttributes
} = require('../utils/operationsUtils')
...
function runTest (payload) {
  return new Promise(function (resolve, reject) {
    ...
    // create an environment variable with component to test. 
    
    // allow a component name or path to a component in kubernetes with namespace/componentName
    process.env.components = 'components/r8-productcatalog'
...
exports.listServiceTest = function (req, res, next) {
  ...
  let query = mongoUtils.getMongoQuery(req)
        ...
        .then(stats => {
          ...
          db.collection(resourceType)
            ...
            .then(doc => {
              ...
              const skip = query.options.skip !== undefined ? parseInt(query.options.skip) : 0
              let limit
